...
#' @param colors Character vector with the colors to use for density and point plotting. 2 values must be supplied if 'background.indices' is supplied. Default is \code{c("#3E4A89FF", "#35B779FF")}.
